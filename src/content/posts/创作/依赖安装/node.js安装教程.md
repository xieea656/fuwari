...
1. 进入官网 [Node.js — 下载 Node.js®](https://nodejs.org/zh-cn/download)
   ![image.png](https://oss.xieea.top/img/20260726162507553.png)
2. 下载Windows版的安装程序（msl）
3. 打开刚下载的文件
4. ![image.png](https://oss.xieea.top/img/20260726162554053.png)
   同意协议
5. ![image.png](https://oss.xieea.top/img/20260726162614371.png)
